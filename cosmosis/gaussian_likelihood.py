...
#        print(self.data_y)
    ...
    def do_likelihood(self, block):
        ...
        x = np.atleast_1d(self.extract_theory_points_wgp(block))
    ...
    def extract_theory_points_wgp(self,block):
        theory_x = block['projected_galaxy_intrinsic', 'r_p']
        theory_y = block['projected_galaxy_intrinsic', 'wgp_r_1_1']
        return self.generate_theory_points(theory_x, theory_y)

    def extract_theory_points_wgg(self,block):
        theory_x = block['projected_galaxy_power', 'r_p']
        theory_y = block['projected_galaxy_power', 'wgg_r_1_1']
        return self.generate_theory_points(theory_x, theory_y)
