"""Source code : https://github.com/harrysjohnston/2ptPipeline/tree/master/ECHOIA
windows function : https://ui.adsabs.harvard.edu/abs/2011MNRAS.410..844M/abstract"""
...
def execute(block, config):
	...
	block[input_section, 'save_name'] = ""
	block[input_section, 'is_auto'] = True
	block[input_section, 'nbin'] = nbin
	block[input_section, 'sep_name'] = 'r_p'
